...
'step 6: At Page_executions click on hyperlink_test_reports_test_execution_test_perform --> navigate to Page_test-reports_test-execution_test-performance'

testObj = findTestObject('Object Repository/Page_team_project_executions/hyperlink_object_1')
