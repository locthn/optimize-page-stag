...
'step 6: At Page_test-reports_test-design_requirement-test-run-coverage click on hyperlink_test_reports_test_design_traceability_re --> navigate to Page_test-reports_test-design_traceability-report'
